...
while (!end) { int num1 = static_cast<size_t>((std::rand() % MAX_NUMBER));
...
case 0 : std::cout << "What's the result of " << num1 << " + " << num2 << " : ";

break;

case 1 : std::cout << "What's the result of " << num1 << " - " << num2 << " : ";

 break;

default : std::cout << "What's the result of " << num1 << " * " << num2 << " : ";
...
std::cout << "Naah! the correct result is : " << num1 + num2 << std::endl;
